...
function [Segment,Model] = Compute_L_KleinHorsman_modTLEM(Segment,Model,f,weight)

% Number of frames
n = size(Segment(2).rM,3);

% -------------------------------------------------------------------------
% Rotation matrix R and traslation vector d, for flex digit and hal
...
Segment(5).nV(:,33	)  = inv(Segment(5).B) *...
    ...
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,34	)  = inv(Segment(5).B) *...    %[0.00549484304875289;0.0597852153130726;0.0828057046938139]*... % Insertion of gluteus maximus (sup) 1
    [-0.0192;-0.0807;0.0274]*... % Insertion of gluteus maximus (sup) 1
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,35	)  = inv(Segment(5).B) *...    %[0.000283493997045463;0.0296579355626409;0.0875236338900292]*... % Insertion of gluteus maximus (sup) 2
    [-0.0155;-0.0931;0.0265]*... % Insertion of gluteus maximus (sup) 2
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,36	)  = inv(Segment(5).B) *...    %[-0.00634241774893979;-0.000263396647675917;0.0927381494278591]*... % Insertion of gluteus maximus (sup) 3
    [-0.0137;-0.1058;0.0259]*... % Insertion of gluteus maximus (sup) 3
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,37	)  = inv(Segment(5).B) *...    %[0.0208627176574498;0.0550426228056364;0.0779234668544846]*... % Insertion of gluteus maximus (sup) 4
    [-0.0128;-0.1187;0.0253]*... % Insertion of gluteus maximus (sup) 4
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,38	)  = inv(Segment(5).B) *...    %[0.0163013293795554;0.0247199840775638;0.0824191667493929]*... % Insertion of gluteus maximus (sup) 5
    [-0.0121;-0.1316;0.0241]*... % Insertion of gluteus maximus (sup) 5
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,39	)  = inv(Segment(5).B) *...    %[0.00902545685975713;-0.00500598915511208;0.0878559115885298]*... % Insertion of gluteus maximus (sup) 6
    [-0.0109;-0.1443;0.0219]*... % Insertion of gluteus maximus (sup) 6
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,40	)  = inv(Segment(5).B) *...
    [-0.026;-0.058;0.051]*... %[-0.0406270814972664;-0.0645684752877772;0.0641140565556898]*... % Insertion of gluteus maximus (inf) 1
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,41	)  = inv(Segment(5).B) *...
    [-0.026;-0.076;0.046]*... %[-0.0390265096571218;-0.07817827475464;0.0592951844618988]*... % Insertion of gluteus maximus (inf) 2
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,42	)  = inv(Segment(5).B) *...
    [-0.022;-0.104;0.043]*... %[-0.0312866731662827;-0.102842841251164;0.0504711213029207]*... % Insertion of gluteus maximus (inf) 3
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,43	)  = inv(Segment(5).B) *...
    [-0.026;-0.058;0.051]*... %[-0.0406270814972664;-0.0645684752877772;0.0641140565556898]*... % Insertion of gluteus maximus (inf) 4
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,44	)  = inv(Segment(5).B) *...
    [-0.026;-0.076;0.051]*... %[-0.0390265096571218;-0.07817827475464;0.0592951844618988]*... % Insertion of gluteus maximus (inf) 5
    (Segment(5).L/Model.Lm(5));
Segment(5).nV(:,45	)  = inv(Segment(5).B) *...
    [-0.026;-0.058;0.051]*... %[-0.0312866731662827;-0.102842841251164;0.0504711213029207]*... % Insertion of gluteus maximus (inf) 6
    (Segment(5).L/Model.Lm(5));
